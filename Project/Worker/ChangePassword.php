...
session_start();
  ...
  {  
   $selqry="select * from tbl_worker where worker_id='".$_SESSION["wid"]."' and worker_password='".$_POST['txt_current']."'";
  ...
  
   {
	   ...
	   {
		   $upquery="update tbl_worker set worker_password='".$_POST["txt_new"]."' where worker_id='".$_SESSION["wid"]."'";
		   $conn->query($upquery);
	   }
   }
  }
