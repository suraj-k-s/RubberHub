...
<body>
  ...
  <table width="200" border="1" align="center" cellpadding="10">
    ...
    <?php
    $slqry = "select * from tbl_market m inner join tbl_place p on p.place_id=m.place_id where market_status=2";
    $i = 0;
    ...
    ?>
      ...
      <tr>
        ...
        <td>
          <a href="NewMarketList.php?aid=<?php echo $row['market_id'] ?>">Accept</a>
        </td>
      </tr>
    <?php
    }
